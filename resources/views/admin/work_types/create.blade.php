<x-app-layout>
    <x-slot name="header">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 class="font-semibold text-xl text-gray-900">Tambah Tipe Kerja</h2>
                <p class="mt-1 text-sm text-gray-700 font-medium">Buat tipe kerja baru (Full-time, Part-time, dll).</p>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg border border-gray-200">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.work_types.store') }}" class="space-y-5">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" required
                                   ...
                                   placeholder="contoh: Full-time / Part-time / Internship / Freelance">
