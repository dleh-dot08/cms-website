<x-app-layout>
    <x-slot name="header">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 class="font-semibold text-xl text-gray-900">Tambah Tag</h2>
                <p class="mt-1 text-sm text-gray-700 font-medium">Slug dibuat otomatis dari nama.</p>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.tags.store') }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" required
                                   ...
                                   placeholder="contoh: Urgent / Remote / Fresh Graduate">
