<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-900">Management — Jenjang</h2>

            <a href="{{ route('admin.jenjangs.create') }}"
                    ...
                    <table class="min-w-full text-sm">
                        <thead class="bg-gray-100">
                            <tr class="text-left">
                                ...
                                <th class="px-4 py-3 font-semibold text-gray-900">Nama Jenjang</th>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <div class="inline-flex gap-3">
                                            <a href="{{ route('admin.jenjangs.show', $row) }}"
                                               class="font-semibold text-gray-900 hover:underline">
                                                Show
                                            </a>
                                            <a href="{{ route('admin.jenjangs.edit', $row) }}"
                                               class="font-semibold text-indigo-700 hover:underline">
                                                Edit
                                            </a>
                                            <form method="POST"
                                                  action="{{ route('admin.jenjangs.destroy', $row) }}"
