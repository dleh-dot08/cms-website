<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-900">Tambah Sub Program</h2>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg border border-gray-200">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.sub_programs.store') }}" class="space-y-5">
                        @csrf
                        ...
                        <div>
                            ...
                            <input name="nama" type="text" value="{{ old('nama') }}" required
                                   placeholder="contoh: Intrakurikuler / Ekstrakurikuler"
                                   class="mt-1 w-full rounded-md border-gray-300 focus:ring-indigo-500 focus:border-indigo-500">
