<x-app-layout>
    <x-slot name="header">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 class="font-semibold text-xl text-gray-900">Lokasi</h2>
                <p class="mt-1 text-sm text-gray-700 font-medium">Kelola lokasi untuk filter recruitment (Jakarta, Remote, Hybrid, dll).</p>
            </div>
